...
public class Demo
{
    ...
    * @exception Exception in an instantiation error occurs
    */
    public Demo( final Logger logger, final PartsManager parts ) throws Exception
    {
        if( logger.isLoggable( Level.INFO ) )
        {
            Component component = parts.getComponentHandler( "widget" );
