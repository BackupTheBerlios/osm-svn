    ...
    */
    ...
    public boolean equals( Object other )
    {
	  ...
	  StandardPrincipal p = (StandardPrincipal) other;
        boolean result = getCertificatePath().equals( p.getCertificatePath() );
        System.out.println("principal equality test: (" + result + ") with " 
	    + getSerialNumber() + " and " + p.getSerialNumber() );
	  return result;
    }
}
