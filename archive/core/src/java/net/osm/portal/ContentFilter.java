...
public class ContentFilter extends net.osm.discovery.ContentFilter implements ValueFactory, FilterOperations
{
    ...
    public ContentFilter( String name, String value ){
	  this.logical = true;
	  this.binary = true;
	  this.name = name;
	  this.value = value;
    ...
    public java.io.Serializable read_value( InputStream is ){
	  return is.read_value( new ContentFilter() );
    }
