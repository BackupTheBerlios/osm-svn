...
implements ServantActivator, Block, LogEnabled, Composable, Configurable, Initializable, Disposable,
RequestCertificateService
{
    ...
    */
    ...
    private final DefaultComponentManager manager = new DefaultComponentManager();
    ...
    */
     ...
     * The <code>Composable</code> implementation should use the supplied
    ...
    throws ComponentException
    {
	  ...
	  try
	  {
		manager.put( "VAULT", provider.lookup("VAULT") );
		manager.put( "ORB", provider.lookup("ORB") );
		manager.put( "PSS-CONNECTOR", provider.lookup("PSS-CONNECTOR") );
		manager.put( "PSS-SESSION", provider.lookup("PSS-SESSION") );
    ...
    throws Exception
    {
        ...
        try
	  {
            ...
            poa = root.create_POA(
			    ...
			    ServantRetentionPolicyValue.RETAIN ) //,
                    //root.create_id_uniqueness_policy( 
	  ...
	  try
	  {
	      ...
	      PersistanceHandler.register( connector, persistence );
            home = (RequestCertificateStorageHome) session.find_storage_home( PSDL );
	  }
	  catch( Throwable throwable )
	  {
        ...
        initialized = true;
        String message = "OSM PKI Certification";
    ...
    */
    ...
    throws org.omg.PortableServer.ForwardRequest
    {
	  try
	  {
		RequestCertificateStorage store = (RequestCertificateStorage) home.get_catalog().find_by_pid( oid );
		...
		servant.compose( manager );
		servant.configure( configuration );
		servant.initialize();
    ...
    */
    public boolean disposeRequestCertificateManager( RequestCertificateManager manager )
    {
        try
	  {
	      poa.deactivate_object( poa.reference_to_id( manager ) );
		return true;
        }
