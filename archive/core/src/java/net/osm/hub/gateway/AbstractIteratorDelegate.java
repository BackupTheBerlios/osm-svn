 ...
 * implementation declares a non-implement exception for all operations. 
 ...
 * maintained by an iterator valuetype, enabling local iteration over a subset 
 * of a remote collection and maintainence of a local stack through a 
 * background thread.
 */
...
public abstract class AbstractIteratorDelegate implements IteratorOperations
{
   ...
   /**
    * ORB against which new Any instances can be created.
    */
    protected ORB orb;
    ...
    */
    public AbstractIteratorDelegate( ORB orb, Iterator iterator )
    {
    ...
    */
    public AbstractIteratorDelegate( ORB orb, LinkedList list, TypeCode type )
    {
	  this( orb, list.iterator(), type );
    }
    ...
    * @param org.omg.CORBA.TypeCode type used as a filter (may be null)
    */
    public AbstractIteratorDelegate( ORB orb, Iterator iterator, TypeCode type )
    {
        this.orb = orb;
    ...
    * operation.
    */
    public boolean not_equal_retrieve_element_set_to_next(org.omg.CosCollection.Iterator test, AnyHolder element)
    throws IteratorInvalid, IteratorInBetween
    {
    ...
    * operations starts.
    */
    public boolean not_equal_replace_element_set_to_next(org.omg.CosCollection.Iterator test, org.omg.CORBA.Any element)
    throws IteratorInvalid, IteratorInBetween, ElementInvalid
    {
        throw new NO_IMPLEMENT();
    }
    ...
    *<p>NOT IMPLEMENTED</P>
    */
    public boolean add_n_elements_set_iterator(org.omg.CORBA.Any[] elements, org.omg.CORBA.IntHolder actual_number)
    throws ElementInvalid
    {
        throw new NO_IMPLEMENT();
    }
    ...
    * an resource maching the supplied type.  The side effect of a failure to 
