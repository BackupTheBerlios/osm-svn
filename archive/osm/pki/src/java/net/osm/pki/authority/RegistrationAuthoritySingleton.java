/*
 * RegistrationAuthoritySingleton.java
 *
...
import org.omg.PKIAuthority.AuthorityProviderInfoHelper;
...
public class RegistrationAuthoritySingleton
{
    ...
    */
    public static void init( ORB current_orb ) 
    {
        ...
        orb.register_value_factory( AuthorityProviderInfoHelper.id(), new AuthorityProviderInfoBase());
    }
}
