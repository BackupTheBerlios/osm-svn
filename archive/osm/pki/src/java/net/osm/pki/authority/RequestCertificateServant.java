...
implements LogEnabled, Serviceable, Configurable, Initializable, Disposable
{
    ...
    */
    ...
    throws ServiceException
    {
	  ...
	  try
	  {
            ...
            orb = (ORB) manager.lookup( "orb" );
            connector = (Connector) manager.lookup( ConnectorContext.CONNECTOR_KEY );
            session = (Session) manager.lookup( SessionContext.SESSION_KEY );
        }
        catch( Exception e )
	  {
