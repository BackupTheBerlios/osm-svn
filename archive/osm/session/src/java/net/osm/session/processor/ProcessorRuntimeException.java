 ...
 * @version 1.0
 */
public class ProcessorRuntimeException extends AbstractResourceRuntimeException
{

    /**
     * Constructs an <code>ProcessorRuntimeException</code> with the specified detail message.
     ...
     */
    public ProcessorRuntimeException( String msg, Throwable ex ) 
    {
        super(msg, ex);
    }
}
