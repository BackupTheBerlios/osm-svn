 ...
 * @version 1.0
 */
public class WorkspaceException extends AbstractResourceException 
{

    /**
     * Constructs an <code>WorkspaceException</code> with the specified detail message.
     ...
     */
    public WorkspaceException( String msg, Throwable ex ) 
    {
        super(msg, ex);
    }
}
