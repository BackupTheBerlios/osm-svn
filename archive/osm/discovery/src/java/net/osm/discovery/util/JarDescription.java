...
import net.osm.discovery.DescriptionBase;
import net.osm.discovery.KeyBase;
import net.osm.discovery.URIBase;
import net.osm.discovery.ChainBase;
import net.osm.discovery.SelectionSetBase;
import net.osm.discovery.SelectionBase;
