...
/**
 * MessageColumnModel is a utility class defining the table column structure
 * for the presentation of SystemMessage instances.
...
public class MessageColumnModel extends DefaultTableColumnModel
{
    ...
    */
    public MessageColumnModel( Font font )
    {
        super();
