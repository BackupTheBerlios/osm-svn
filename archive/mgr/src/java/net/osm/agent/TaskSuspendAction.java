...
/**
 * Action to suspend a task.
 *
 * @author  Stephen McConnell
 * @version 1.0 21 JUN 2001
 */
class TaskSuspendAction extends AbstractAction implements PropertyChangeListener
{
    ...
    */
    public TaskSuspendAction( Shell shell, String name, TaskAgent task ) 
    {
        super( name );
	  this.shell = shell;
        this.task = task;
    ...
    */
    public void actionPerformed( ActionEvent event )
    {
	  ...
	  {
		final String error = "cannot suspend the task";
		shell.error( error, e );
	  }
    }
}
